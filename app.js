...
function grid_clicked(b)
{
    ...
    let p = b.target.firstChild.textContent; 
    if(isValidClick(b.target))
    {
        b.target.style.backgroundColor = '#99FFCD';
        word_to_find = word_to_find.substring(1);
        last_pos = get_pos(b.target.id);
    ...
    {
        let pcolor = b.target.style.backgroundColor;
        b.target.style.backgroundColor = '#F24A72';
